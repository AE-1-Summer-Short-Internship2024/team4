...
//年齢別、性別別に人数をカウント
  ...
  const products = {
    food: [
        { id: 1, name: '水', quantity: `${ageGroups.Adult * 2 + genderGroups.male * 1.5}L`, url: `${baseUrl}水`, purchased: false },
        { id: 2, name: 'レトルトご飯', quantity: `${ageGroups.Adult * 3 + genderGroups.female * 2}食`, url: `${baseUrl}レトルトご飯`, purchased: false },
        { id: 3, name: 'レトルト食品', quantity: '6個', url: `${baseUrl}レトルト食品`, purchased: false },
        { id: 4, name: '缶詰(さばの味噌煮、野菜など)', quantity: '6缶', url: `${baseUrl}缶詰(さばの味噌煮、野菜など)`, purchased: false },
        { id: 5, name: '栄養補助食品', quantity: '6箱', url: `${baseUrl}栄養補助食品`, purchased: false },
        { id: 6, name: '野菜ジュース', quantity: '6本', url: `${baseUrl}野菜ジュース`, purchased: false },
        { id: 7, name: 'チーズ・プロテインバー等', quantity: '2パック', url: `${baseUrl}チーズ・プロテインバー等`, purchased: false },
        { id: 8, name: '健康飲料粉末', quantity: '6袋', url: `${baseUrl}健康飲料粉末`, purchased: false },
        { id: 9, name: '調味料セット', quantity: '適宜', url: `${baseUrl}調味料セット`, purchased: false },
        { id: 10, name: '乾麺 即席麺', quantity: '7パック', url: `${baseUrl}乾麺 即席麺`, purchased: false },
        { id: 11, name: '無洗米', quantity: '3kg', url: `${baseUrl}無洗米`, purchased: false },
        { id: 12, name: '飲み物', quantity: '6本', url: `${baseUrl}飲み物`, purchased: false },
        { id: 13, name: 'お菓子', quantity: '7パック', url: `${baseUrl}お菓子`, purchased: false },
        { id: 14, name: '果物の缶詰', quantity: '7缶', url: `${baseUrl}果物の缶詰`, purchased: false },
        { id: 15, name: '乾物', quantity: '適量', url: `${baseUrl}乾物`, purchased: false },
        { id: 16, name: 'フリーズドライ食品', quantity: '適量', url: `${baseUrl}フリーズドライ食品`, purchased: false },
    ],
    hygiene: [
        //TODO:必要量を計算する
